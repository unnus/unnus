...
<section id="Formingcoremessage">
	
<h2>#1 Core Message</h2>
<p>A Core Message is what you want your patients to know about your medical brand and how it <strong>benefits</strong> them.</p>
<p>And Secondary Messages are the core message, dissected to pieces.</p>
<p>Multiple secondary messages make up your whole core message</p>
<p><strong>Example: </strong></p>
<p>Let&rsquo;s say that you run a chiropractic clinic</p>
<p>A core message with a secondary messages might be as follows</p>
<img src="/assets/course-assets/example/cf-e.jpg" alt="Brand voice example 2 in healthcare" />
<p>To start forming your core message</p>
<p>You:</p>
<ol>
<li>Start by formulating a core message</li>
<li>Sum up your message in one concise sentence</li>
<li>deconstruct that core message into various secondary messages</li>
</ol>
<p>Why use secondary messages? Because you want to make your communication easy to digest for patients</p>
<p>You can&rsquo;t describe what your medical brand is all about using one repetitive message.</p>
<p>Instead, block by block, you nurture your potential patients about your brand.</p>
<p>This will make it easier for people to take-in your values and your position in the market.</p>
<p>We&rsquo;ll also use them to integrate storytelling and convey your medical brand to your patients</p>
<p>How? read on</p>
</section>

<section id="Storytellinginhealthcare">
	
<h2>#2 Healthcare Brand Storytelling</h2>
<p>People, by nature, digest stories with ease.</p>
<p>For that, we&rsquo;ll use storytelling tactics.</p>
<p>Storytelling is conveying your brand story using multiple snippets in your communication.</p>
<p>These small sets of stories will inform patients about your position in the market.</p>
<p>You&rsquo;ll take your secondary-messages and construct small stories around them.</p>
<p>Seems vague?</p>
<p>Let me use a real-world case from one of our clients.</p>
<p>Our client had a community hospital and we were running a maternity marketing campaign.</p>
<p>After the research, we found that women experienced great chaos.</p>
<p>From navigating the obstetrics medical process to the unsolicited advice.</p>
<p>Women dealt with the expertise of her &ldquo;all-knowing&rdquo; friends and relatives.</p>
<p>&ldquo;you&rsquo;re carrying high&mdash;it must be a boy!&rdquo;</p>
<p>Add to that the conflicting information she reads in books</p>
<p>All this led to confusion, stress and <strong>feeling out of control</strong></p>
<p>Knowing that we chose a core message for the campaign to be</p>
<p>&ldquo;Shape your own birth experience&rdquo;</p>
<p>&nbsp;This message carries multiple ideas, such:</p>
<ol>
<li>Empowerment of pregnant women</li>
<li>Personalized birth experience</li>
<li>Staying in charge and be in the know of your situation</li>
</ol>
<p>we took these secondary messages and made marketing campaigns for each one of them.</p>
<p>The simplified process looked like this</p>
<img src="/assets/course-assets/example/cf-example-3.jpg" alt="Brand voice example 3 in healthcare" />
<p>Each marketing channel, articles, social posts, eBooks, brochures, told a specific story.</p>
<p>The story of the confusions pregnant women went through, and how they felt out of control.</p>
<p>And in these channels, we inject what solutions our community hospital has to offer.</p>
<p>Each one of the media posts is laser-focused on one problem, provided one solution, and told one story.</p>
<p>These small sets of posts, messages, and ads, all pile up together to form the whole core message, &ldquo;<strong>shape your own birth experience</strong>&rdquo;.</p>
<p>Here at unnus, we use a storytelling techniques or a derivative version of it whenever we can</p>
